...
tribble(
  ...
  knitr::kable(caption = "Summary of pedagogical benefits of the tidyverse discussed in this paper.\\label{tab:summary}", label = "tab:summary", booktabs = TRUE, linesep = "\\addlinespace") |>
...
```{r data-science-cycle, fig.cap="Data science cycle and the core tidyverse packages that address each phase. Image credit: \\cite{wickham2016r}.", echo = FALSE, fig.align = "center", out.width = "80%"}
