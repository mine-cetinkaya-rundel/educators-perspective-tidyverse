...
and data science tasks are accomplised with the tidyverse, and discuss
...
software)'' \citep{CarEve2016}. In both statistics and data science
courses, we believe it is important to teach authentic tools, i.e.,
tools that are used by practitioners of these disciplines (academics and
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# From the ColorBrewer Set2 palette}
